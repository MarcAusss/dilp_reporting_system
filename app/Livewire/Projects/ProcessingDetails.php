...
class ProcessingDetails extends Component
{
    ...
    public string $procurement_method = '';
    public bool $procurement_is_epa = false;
    ...
    public string $payee = '';
    public string $payment_prepared_at = '';
    public string $payment_forwarded_to_signatories_at = '';
    public string $payment_released_at = '';
    public string $check_lddap_number = '';
    public string $check_lddap_date = '';
    public string $payment_dv_number = '';
    ...
    public string $replacement_beneficiaries_replaced = '';
    public string $replacement_original_beneficiary = '';
    public string $replacement_new_beneficiary = '';
    public string $replacement_approval_letter_date = '';
    public string $replacement_released_at = '';
    public string $replacement_are_insurance_received_at = '';
    ...
    public function editProcurement(int $id): void
    {
        ...
        $this->procurement_method = $record->procurement_method ?? '';
        $this->procurement_is_epa = (bool) $record->is_epa;
    ...
    public function saveProcurement(): void
    {
        ...
        $validated = $this->validate([
            ...
            'procurement_method' => ['nullable', 'string', 'max:150'],
            'procurement_is_epa' => ['boolean'],
        ...
        $record->fill([
            ...
            'procurement_method' => $this->nullableTrim($validated['procurement_method'] ?? null),
            'is_epa' => (bool) ($validated['procurement_is_epa'] ?? false),
    ...
    public function editDisbursement(int $id): void
    {
        ...
        $this->payment_prepared_at = $record->prepared_at?->format('Y-m-d') ?? '';
        $this->payment_forwarded_to_signatories_at = $record->forwarded_to_signatories_at?->format('Y-m-d') ?? '';
        $this->payment_released_at = $record->released_at?->format('Y-m-d\TH:i') ?? '';
        $this->check_lddap_number = $record->check_lddap_number ?? '';
        $this->check_lddap_date = $record->check_lddap_date?->format('Y-m-d') ?? '';
        $this->payment_dv_number = $record->dv_number ?? '';
    ...
    public function saveDisbursement(): void
    {
        ...
        $validated = $this->validate([
            ...
            'payment_prepared_at' => ['nullable', 'date'],
            'payment_forwarded_to_signatories_at' => ['nullable', 'date'],
            'payment_released_at' => ['nullable', 'date'],
            'check_lddap_number' => ['nullable', 'string', 'max:150'],
            'check_lddap_date' => ['nullable', 'date'],
            'payment_dv_number' => ['nullable', 'string', 'max:150'],
        ...
        $record->fill([
            ...
            'prepared_at' => $validated['payment_prepared_at'] ?: null,
            'forwarded_to_signatories_at' => $validated['payment_forwarded_to_signatories_at'] ?: null,
            'released_at' => $validated['payment_released_at'] ?: null,
            'check_lddap_number' => $this->nullableTrim($validated['check_lddap_number'] ?? null),
            'check_lddap_date' => $validated['check_lddap_date'] ?: null,
            'dv_number' => $this->nullableTrim($validated['payment_dv_number'] ?? null),
    ...
    public function editReplacement(int $id): void
    {
        ...
        $this->replacement_beneficiaries_replaced = $record->beneficiaries_replaced !== null ? (string) $record->beneficiaries_replaced : '';
        $this->replacement_original_beneficiary = $record->original_beneficiary ?? '';
        $this->replacement_new_beneficiary = $record->replacement_beneficiary ?? '';
        $this->replacement_approval_letter_date = $record->approval_letter_date?->format('Y-m-d') ?? '';
        $this->replacement_released_at = $record->released_at?->format('Y-m-d\TH:i') ?? '';
        $this->replacement_are_insurance_received_at = $record->are_insurance_received_at?->format('Y-m-d') ?? '';
    ...
    public function saveReplacement(): void
    {
        ...
        $validated = $this->validate([
            ...
            'replacement_beneficiaries_replaced' => ['nullable','integer','min:0'],
            'replacement_original_beneficiary' => ['nullable','string','max:5000'],
            'replacement_new_beneficiary' => ['nullable','string','max:5000'],
            'replacement_approval_letter_date' => ['nullable','date'],
            'replacement_released_at' => ['nullable','date'],
            'replacement_are_insurance_received_at' => ['nullable','date'],
        ...
        $record->fill([
            ...
            'beneficiaries_replaced' => $validated['replacement_beneficiaries_replaced'] ?: null,
            'original_beneficiary' => $this->nullableTrim($validated['replacement_original_beneficiary'] ?? null),
            'replacement_beneficiary' => $this->nullableTrim($validated['replacement_new_beneficiary'] ?? null),
            'approval_letter_date' => $validated['replacement_approval_letter_date'] ?: null,
            'released_at' => $validated['replacement_released_at'] ?: null,
            'are_insurance_received_at' => $validated['replacement_are_insurance_received_at'] ?: null,
    ...
    private function resetDisbursementForm(): void
    {
        ...
        $this->payee = '';
        $this->payment_prepared_at = '';
        $this->payment_forwarded_to_signatories_at = '';
        $this->payment_released_at = '';
        $this->check_lddap_number = '';
        $this->check_lddap_date = '';
        $this->payment_dv_number = '';
    ...
    private function resetReplacementForm(): void
    {
        ...
        $this->replacement_beneficiaries_replaced = '';
        $this->replacement_original_beneficiary = '';
        $this->replacement_new_beneficiary = '';
        $this->replacement_approval_letter_date = '';
        $this->replacement_released_at = '';
        $this->replacement_are_insurance_received_at = '';
